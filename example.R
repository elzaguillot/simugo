...
plot(result$pval_classic,col=result$active+1,main="",ylab="pvalue",xlab="go index") # shows the pvalue color coded by the true activity of the gene set
abline(0.05,0,lty=2) # pvalue threshold at 0.05
text(5,0.07,"pvalue = 0.05 threshold")
...
#png("exple3.png")
hist(result$pval_classic[which(!result$active)],col=rgb(1,0,0,0.4),xlab="pvalue",ylab="number of go",main="")
