...
experiment # this object contains the data for a simulated experiments, with a list of active go and a list of active genes and their simulated covariate
